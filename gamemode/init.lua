...
GM.AdjustingPlayerColors = CreateConVar("mb_powerup_playercolors", 0, bit.bor(FCVAR_NOTIFY), "Whether or not playercolors will change based off of the players powerups(default 0)" )
